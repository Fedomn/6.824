...
func (kv *ShardKV) getDuplicatedCommandReply(clientId, sequenceNum int64) (bool, CommandReply) {
	lastOperation, ok := kv.sessions[clientId]
	if ok {
...
func (kv *ShardKV) setSession(clientId, sequenceNum int64, reply CommandReply) {
